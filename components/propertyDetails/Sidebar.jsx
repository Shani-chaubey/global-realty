...
export default function Sidebar({ property }) {
  ...
  return (
    <div className="tf-sidebar sticky-sidebar" id="contact-seller">
      ...
      <form className="form-contact-seller mb-30" onSubmit={handleSubmit1}>
        ...
        <div className="seller-info">
          <div className="avartar">
            <Image
              ...
              src={agent?.avatar || "https://www.w3schools.com/howto/img_avatar.png"}
              width={200}
              height={200}
            />
          </div>
        ...
        {submitted1 ? (
          <div style={{ padding: "1rem 0" }}>
            ...
            <p className="text-1 text-color-default" style={{ marginTop: "0.25rem" }}>
          ...
          <>
            ...
            <fieldset className="mb-30">
              <textarea
                ...
                value={form1.message}
                onChange={(e) => setForm1((p) => ({ ...p, message: e.target.value }))}
                required
              />
            </fieldset>
            <button
      ...
      {/* ── Form 2: More About This Property ── */}
          ...
          <>
            <fieldset>
              <input
                ...
                value={form2.name}
                onChange={(e) => setForm2((p) => ({ ...p, name: e.target.value }))}
                required
              />
            </fieldset>
            <fieldset>
            ...
            <fieldset className="phone">
              <input
                ...
                placeholder="Phone"
                value={form2.phone}
                onChange={(e) => setForm2((p) => ({ ...p, phone: e.target.value }))}
              />
            </fieldset>
            <fieldset>
              <textarea
                ...
                placeholder="Message *"
                value={form2.message}
                onChange={(e) => setForm2((p) => ({ ...p, message: e.target.value }))}
                required
              />
            </fieldset>
