...
export default function Featured() {
  return (
    <section className="section-featured tf-spacing-1">
      <div className="box-house style-list style-3">
        <div className="image-wrap img-animation2 wow animate__animated">
          <a href="#" className="">
            <Image
              className="lazyload"
              data-src="/images/section/section-featured.jpg"
              alt=""
              width={940}
              height={692}
              src="/images/section/section-featured.jpg"
            />
          </a>
        </div>
        <div className="wrap-content">
          <div className="content">
            <h2 className="mb-48">Featured Properties</h2>
            <div className="heading">
              <ul className="box-tag flex gap-8">
                <li className="flat-tag text-4 bg-main text_white">For Sale</li>
                <li className="flat-tag text-4 bg-main-sub-2 text-color-primary">
                  Featured
                </li>
              </ul>
              <h3 className="title">
                <a href="#">Rancho Vista Verde, Santa Barbara</a>
              </h3>
              <ul className="meta-list flex">
                <li className="meta-item">
                  <div className="text-4 flex">
              ...
              <p className="location text-1 flex items-center gap-6">
                <i className="icon-location" /> 102 Ingraham St, Brooklyn, NY
                11237
              </p>
            </div>
            ...
            <div className="bot flex justify-between items-center">
              <h3 className="price">
                $250,00 <span className="text-1 fw-4">/month</span>
              </h3>
